 ...
 * @vesion: 
 * @Author: sunzhguy
 * @Date: 2020-06-08 09:08:01
 * @LastEditor: sunzhguy
 * @LastEditTime: 2020-06-08 15:59:51
 */ 
#ifndef _AENC_H_
#define _AENC_H_
#include "types.h"
...
{ 
    U64  u64TimeStamp;   /* Time stamp                      */
    U32  u32FrameNum;    /* Encode frame number             */
    U32  u32Len;         /* Encode data length              */
    S16 *ps16Addr;       /* Encode data buffer address      */
...
typedef struct _T_AUDIO_ENC_ATTR
{
    ...
    BOOL bFlag;		  /* the flag indicate block */
}T_AUDIO_ENC_ATTR;
...
typedef struct _T_AUDIO_RAWDATA
{
    ...
    AUDIO_SAMPLE_RATE_E  enSampleRate;  /* Sample rate                   */
    U64               u64TimeStamp;  /* The time stamp                */
    U32               u32FrameNum;   /* The frame number              */
    S16              *ps16Addr;      /* The buffer address            */
    U32               u32Length;     /* The available data length     */
} T_AUDIO_RAWDATA;
